...
class _AlipayAccountPageState extends State<AlipayAccountPage> {
  ...
  void saveAlipayAccountInfo() async {
    ...
    if (isSuccess) {
      ...
      setState(() {
        _account = AlipayAccountModel(accountUserName: nameTextCon.text, accountNumber: accountTextCon.text);
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text("支付宝账号", style: TextStyle(color: Colors.black, fontSize: 16)),
                          Text(_accountNum, style: TextStyle(color: Color(0xff969696), fontSize: 16)),
                        ],
                      ),
                    ),
                    Container(height: 1.5, color: Color(0xFFF9F9F9), margin: EdgeInsets.only(left: 15, right: 15)),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 12, color: Color(0xffe60113))
                  )
                ),
                SizedBox(height: 150),
                saveButton(),
  ...
  Widget accountAndNameView(bool isAccount) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(isAccount ? "支付宝账号" : "姓名", style: TextStyle(color: Colors.black, fontSize: 16)),
          Expanded(
            child: TextField(
